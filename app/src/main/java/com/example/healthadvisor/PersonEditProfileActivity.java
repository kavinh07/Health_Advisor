...
public class PersonEditProfileActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_person_edit_profile);
        ...
        exitButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(PersonEditProfileActivity.this, PatientHomePage.class));
            }
        });
    }
    ...
    public void updatePerson() {
        ...
        if(!(pass.equals(confirmPass))){
            ...
            person.updatePassword(pass).addOnSuccessListener(new OnSuccessListener<Void>() {
                ...
                public void onSuccess(Void unused) {
                    Toast.makeText(PersonEditProfileActivity.this, "Pass reset", Toast.LENGTH_SHORT).show();
                }
            });
        }
        ...
        dR.child(UID).updateChildren(map).addOnSuccessListener(new OnSuccessListener<Void>() {
            @Override
            public void onSuccess(Void unused) {
                Toast.makeText(PersonEditProfileActivity.this, "Success", Toast.LENGTH_SHORT).show();
            }
        });
